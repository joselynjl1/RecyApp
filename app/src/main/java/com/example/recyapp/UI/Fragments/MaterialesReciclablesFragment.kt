 ...
 * Use the [MaterialesReciclablesFragment.newInstance] factory method to
...
class MaterialesReciclablesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment MaterialesReciclablesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MaterialesReciclablesFragment().apply {
